...
def test_all_success():
    ...
    report = {
        "success": True, "results": [
            {"step": 1, "success": True, "action": "observe_surroundings"},
            {"step": 2, "success": True, "action": "rotate_find_align"},
...
def test_fail_then_replan_success():
    ...
    report = {
        "success": False,
        "results": [
            {"step": 1, "success": True, "action": "observe_surroundings", "message": "ok"},
            {"step": 2, "success": False, "action": "rotate_find_align", "message": "未找到目标"},
            {"step": 3, "success": True, "action": "explore_no_align", "message": "找到目标"},
...
def test_replan_exhausted():
    ...
    report = {
        ...
        "results": [
            {"step": 1, "success": True, "action": "observe_surroundings", "message": "ok"},
            {"step": 2, "success": False, "action": "rotate_find_align", "message": "未找到目标"},
            {"step": 3, "success": False, "action": "explore_no_align", "message": "达到最大轮数"},
            {"step": 4, "success": False, "action": "explore_no_align", "message": "达到最大轮数"},
