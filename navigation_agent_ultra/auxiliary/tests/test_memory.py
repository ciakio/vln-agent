...
def test_high_confidence_realtime_write():
    ...
    m.add_step_result(1, "vision_observe", "detect_object_360",
                      {"target": "椅子"},
                      {"success": True, "data": {"perceptions": {
                          "objects_found": [{"name": "椅子", "confidence": 0.8, "depth": 2.0,
                                             "direction": 90, "source_action": "detect_object_360"}],
                          "areas_explored": [],
...
def test_low_confidence_no_realtime_write():
    ...
    m.add_step_result(1, "vision_observe", "look_around",
                      {}, {"success": True, "data": {"perceptions": {
...
def test_same_name_merge():
    ...
    time.sleep(0.1)
    m2 = MemoryManager(memory_dir=d)
    m2.add_step_result(1, "vision_observe", "detect_object_360",
                       {"target": "椅子"},
                       {"success": True, "data": {"perceptions": {
...
def test_reviewer_success():
    r = Reviewer()
    review = r.review("测试", {"steps": [{"action": "detect_object_360"}]},
                      {"success": True,
                       "results": [{"success": True, "action": "detect_object_360",
...
def test_reviewer_failure():
    r = Reviewer()
    review_fail = r.review("测试", {"steps": [{"action": "detect_object_360"}]},
                           {"success": False,
                            "results": [{"success": False, "action": "detect_object_360",
